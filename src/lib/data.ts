...
export const fundsData: Fund[] = [
  ...
  },
  {
    ...
    hoteis: [
      ...
      { nome: 'Hotel Intercontinental Estoril', localizacao: 'Cascais', imagem: { src: 'https://ik.imagekit.io/leosmc2zb/IC-Cascais-Estoril.jpg', v: 2 }, dataAiHint: 'coastal hotel view' },
