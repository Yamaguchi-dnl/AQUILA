...
export const fundsData: Fund[] = [
  {
    ...
    imagemResumo: 'https://ik.imagekit.io/leosmc2zb/1331.jpg',
  ...
  },
  {
    ...
    hoteis: [
      { nome: 'Valverde Lisboa Hotel & Garden', localizacao: 'Centro de Lisboa', imagem: 'https://ik.imagekit.io/leosmc2zb/valverde-hotel-facade.jpg', dataAiHint: 'luxury hotel facade' },
