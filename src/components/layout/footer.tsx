...
export function Footer() {
  ...
  return (
    <footer className="bg-primary text-primary-foreground/80 relative z-10 rounded-t-3xl md:-mt-16">
       <div
        aria-hidden="true"
        className="absolute inset-0 bg-[radial-gradient(30%_40%_at_5%_95%,rgba(255,255,255,0.1)_0%,rgba(25.5,255,255,0)_100%),radial-gradient(30%_40%_at_95%_5%,rgba(255,255,255,0.1)_0%,rgba(255,255,255,0)_100%)] rounded-t-3xl"
      />
