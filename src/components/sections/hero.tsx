...
export function Hero() {
  return (
    <section className="relative w-full h-[85vh] min-h-[600px] flex items-center justify-center text-white p-0">
      <Image
        ...
        priority
      />
      <div className="absolute inset-0 bg-gradient-to-t from-primary/90 to-primary/50 z-10"></div>
      <div className="relative z-20 text-center container px-4 md:px-6">
        <h1 className="font-headline text-4xl md:text-6xl lg:text-7xl tracking-tight text-white/90">
          Sua estratégia de sucesso para investir no exterior
        </h1>
        <p className="mt-4 md:mt-6 max-w-3xl mx-auto text-lg md:text-xl text-primary-foreground/80">
