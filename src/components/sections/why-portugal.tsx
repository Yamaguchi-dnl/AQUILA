        ...
        >
          <AnimatedSection>
            <div className="flex justify-between items-center mb-8">
              <h2 className="font-headline text-3xl md:text-4xl lg:text-4xl text-primary-foreground uppercase">Por que investir<br />em Portugal?</h2>
            ...
            <CarouselContent className="-ml-4">
              {benefits.map((benefit, index) => (
                <CarouselItem key={index} className="pl-4">
                    <Card className="bg-primary-foreground/5 border-primary-foreground/10 text-primary-foreground h-[220px] w-[280px] hover:bg-primary-foreground/10 transition-colors">
